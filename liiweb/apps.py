...
class LiiwebConfig(AppConfig):
    ...
    def ready(self):
        from docpipe.citations import (
            AchprResolutionMatcher,
            ActNoOfYearMatcher,
            ActYearNumberMatcher,
        )
        ...
        citation_analyser.matchers.append(ActNoOfYearMatcher)
        citation_analyser.matchers.append(ActYearNumberMatcher)

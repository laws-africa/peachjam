...
(function (global, factory) {
  ...
  function mapToStyles (_ref2) {
    ...
    var _ref3$x = _ref3.x;
    var x = _ref3$x === void 0 ? 0 : _ref3$x;
    var _ref3$y = _ref3.y;
    var y = _ref3$y === void 0 ? 0 : _ref3$y;
    ...
    return function createPopper (reference, popper, options) {
      ...
      var instance = {
        ...
        forceUpdate: function forceUpdate () {
          ...
          var popper = _state$elements.popper; // Don't proceed if `reference` or `popper` are not valid elements
          // anymore

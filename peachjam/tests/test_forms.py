...
class BaseDocumentFilterFormTestCase(TestCase):
    ...
    def test_years_filter(self):
        ...
        self.assertEqual(response.context["facet_data"]["years"], [2022])
    ...
    def test_years_filter_with_multiple_years(self):
        ...
        response = self.client.get(
            "/legal_instruments/?years=2022&years=1990&years=1972"
        )
        documents = response.context.get("documents")
        ...
        self.assertEqual(response.context["facet_data"]["years"], [2022, 1972, 1990])

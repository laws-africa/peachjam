...
urlpatterns = [
    ...
    path(
        "judgments/<str:court_code>/",
        CourtDetailView.as_view(),
        name="court",
    ),
    path(
        "judgments/<str:court_code>/<int:year>/",
        CourtYearView.as_view(),
        name="court_year",
    ),
    path(
        "judgments/<str:court_code>/<str:registry_code>/",
        CourtRegistryView.as_view(),
        name="court_registry",
    ),
    path(
        "judgments/<str:court_code>/<str:registry_code>/<int:year>/",

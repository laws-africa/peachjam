...
from peachjam.views import (
    ...
    FlynoteManagerMergePickerView,
    FlynoteManagerMergeView,
...
urlpatterns = [
    ...
    path(
        "autocomplete/judge-people",
        JudgePeopleAutocomplete.as_view(),
        name="autocomplete-judge-people",
    ),
    path(
    ...
    path(
        "flynote-manager/workspace/<int:pk>/merge/",
        FlynoteManagerMergeView.as_view(),
        name="flynote-manager-merge",
    ),
    path(
        "flynote-manager/workspace/<int:pk>/merge/picker/",
        FlynoteManagerMergePickerView.as_view(),
        name="flynote-manager-merge-picker",
    ),

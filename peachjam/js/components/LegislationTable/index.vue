...
export default {
  ...
  mounted () {
    ...
    const jsonElement = document.querySelector('#legislation-table-data');
  ...
  methods: {
    ...
    filterData () {
      ...
      data = data.filter(item => item[this.selectedFilterKey]
        .toLowerCase().includes(this.filters[this.selectedFilterKey].value.toLowerCase()));
